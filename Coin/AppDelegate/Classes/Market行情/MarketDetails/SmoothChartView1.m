...
@implementation SmoothChartView1
...
-(void)makeChartXView{
    ...
    layerX.frame = CGRectMake(0,LABLE_HEIGHT, LABLE_WIDTH, 1);
...
-(void)makeChartYView{
    ...
    UIView *lineView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, 1, 200)];
    [lineView theme_setBackgroundColorIdentifier:LineViewColor moduleName:ColorName];
    [self addSubview:lineView];
    
    UIView *lineView1 = [[UIView alloc]initWithFrame:CGRectMake(SCREEN_WIDTH - 30 - 1, 0, 1, 200)];
    [lineView1 theme_setBackgroundColorIdentifier:LineViewColor moduleName:ColorName];
    [self addSubview:lineView1];
    
    UIView *lineView2 = [[UIView alloc]initWithFrame:CGRectMake(0, 199, SCREEN_WIDTH - 30, 1)];
...
-(void)makeBottomlayer{
    ...
    _bottomLayer.frame = CGRectMake(2,25 + LABLE_HEIGHT/5, SCREEN_WIDTH - 34, 147 - LABLE_HEIGHT/5);
...
-(void)drawSmoothViewWithArrayX:(NSArray*)pathX andArrayY:(NSArray*)pathY andScaleX:(float)X andScalemax:(float)max andScalemin:(float)min{
    ...
    layer.strokeColor = kHexColor(@"#77A4FF").CGColor;
    ...
    for (int i= 0; i< pathY.count; i++) {
        ...
        CGFloat X = i * (SCREEN_WIDTH - 34)/(pathY.count - 1);
...
- (void)drawGradient {
    ...
    gradientLayer.frame = CGRectMake(2, 0, (SCREEN_WIDTH - 34), 147 - LABLE_HEIGHT/5);
    gradientLayer.colors =@[(__bridge id)[UIColor colorWithRed:119/255.0 green:164/255.0 blue:255/255.0 alpha:0.5].CGColor,(__bridge id)[UIColor colorWithRed:60/255.0 green:82/255.0 blue:182/255.0 alpha:0.0].CGColor];
    ...
    endPoint = CGPointMake(endPoint.x - 5 , (SCREEN_WIDTH - 34));
