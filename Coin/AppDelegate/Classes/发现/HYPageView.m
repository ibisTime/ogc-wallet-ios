...
- (void)layoutSubviews{
    ...
    [_topTabView theme_setBackgroundColorIdentifier:BackColor moduleName:ColorName];
    [_topTabScrollView theme_setBackgroundColorIdentifier:BackColor moduleName:ColorName];
...
- (UIScrollView *)scrollView{
    if (!_scrollView) {
        ...
        [_scrollView theme_setBackgroundColorIdentifier:BackColor moduleName:ColorName];
...
- (void)updateSelectedPage:(NSInteger)page{
    for (UIButton *button in _titleButtons) {
        if (button.tag == page) {
            ...
            [button theme_setBackgroundImageIdentifier:GaryLabelColor forState:(UIControlStateNormal) moduleName:ColorName];
//            [button setTitleColor:_unselectedColor forState:UIControlStateNormal];
            [button setTitleColor:kTextColor2 forState:UIControlStateNormal];
            if (_isAnimated) {
                [UIView animateWithDuration:0.3 animations:^{
