...
-(instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        _stateLabel = [UILabel labelWithFrame:CGRectMake(0, 0, 0, 0) textAligment:(NSTextAlignmentCenter) backgroundColor:kClearColor font:FONT(9) textColor:kTabbarColor];
