...
-(void)initUI
{
    ...
    backView.backgroundColor = kTabbarColor;
    ...
    UIButton *IncreaseBtn = [UIButton buttonWithTitle:[LangSwitcher switchLang:@"我要增加信用积分" key:nil] titleColor:kHexColor(@"#FFFFFF") backgroundColor:kTabbarColor titleFont:16];
